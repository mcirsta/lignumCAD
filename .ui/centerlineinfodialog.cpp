/****************************************************************************
** Form implementation generated from reading ui file 'centerlineinfodialog.ui'
**
...
static QPixmap uic_load_pixmap_CenterlineInfoDialog( const QString &name )
{
...
/* 
 *  Constructs a CenterlineInfoDialog which is a child of 'parent', with the 
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  TRUE to construct a modal dialog.
 */
CenterlineInfoDialog::CenterlineInfoDialog( QWidget* parent,  const char* name, bool modal, WFlags fl )
    : QDialog( parent, name, modal, fl )
{
    if ( !name )
	setName( "CenterlineInfoDialog" );
    resize( 400, 248 ); 
    setCaption( trUtf8( "Centerline Information" ) );
    setIcon( uic_load_pixmap_CenterlineInfoDialog( "lignumCAD.png" ) );
    CenterlineInfoDialogLayout = new QGridLayout( this, 1, 1, 11, 6, "CenterlineInfoDialogLayout"); 
    ...
    CenterlineInfoDialogLayout->addMultiCellLayout( Layout1, 2, 2, 0, 1 );
    ...
    QWhatsThis::add( referenceLineEdit, trUtf8( "<p><b>Offset Reference</b></p> <p>This widget shows the geometry item which the centerline is offset from. This value is not editable in this dialog; you must use the regular interface to adjust constraint references.</p>" ) );
...
"<p>Select this option if you want the centerline to have an independent, specified offset.</p>" ) );
...
"<p>If you modify the value, you can always go back to the default value when the dialog was opened by clicking the <img src=\"default_active.png\"> button</p>" ) );
    ...
    CenterlineInfoDialogLayout->addWidget( definitionGroupBox, 1, 0 );

    Layout15 = new QHBoxLayout( 0, 0, 6, "Layout15"); 

    centerlineNameLabel = new QLabel( this, "centerlineNameLabel" );
    centerlineNameLabel->setText( trUtf8( "&Name:" ) );
    Layout15->addWidget( centerlineNameLabel );

    nameEdit = new QLineEdit( this, "nameEdit" );
    QToolTip::add( nameEdit, trUtf8( "Edit the centerline's name." ) );
    QWhatsThis::add( nameEdit, trUtf8( "<p><b>Name</b></p>\n"
"<p>Edit the name of the centerline. The centerline's name will be updated when the dialog is accepted. If there is already a centerline on this page which has the same name, the name change will be rejected.</p>" ) );
    Layout15->addWidget( nameEdit );

    CenterlineInfoDialogLayout->addLayout( Layout15, 0, 0 );

    orientationButtonGroup = new QButtonGroup( this, "orientationButtonGroup" );
    orientationButtonGroup->setTitle( trUtf8( "Orientation" ) );
    QToolTip::add( orientationButtonGroup, trUtf8( "Orientation of the centerline." ) );
    ...
    CenterlineInfoDialogLayout->addWidget( orientationButtonGroup, 1, 1 );
    ...
    // buddies
    centerlineNameLabel->setBuddy( nameEdit );
}

/*  
 *  Destroys the object and frees any allocated resources
 */
CenterlineInfoDialog::~CenterlineInfoDialog()
{
